...
const About = () => {
  return (
    <section id="about" className="py-20 px-4  text-white">
      <div className="max-w-4xl mx-auto bg-white text-gray-800 p-10 rounded-3xl shadow-lg relative">
        {/* Profile Image */}
        ...
        <div className=" text-center">
          ...
          <div className="mt-6 flex justify-center gap-6">
            <div className="text-center">
              <p className="text-3xl font-bold text-blue-500 animate-pulse">5+</p>
              <p className="text-gray-600">Years Experience</p>
            </div>
            <div className="text-center">
              <p className="text-3xl font-bold text-blue-500 animate-pulse">50+</p>
