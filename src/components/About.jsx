    ...
    <section id="about" className="py-20 px-4 text-white" ref={aboutRef}>
      <div className="max-w-7xl mx-auto  text-gray-800 p-10 rounded-3xl relative shadow-lg shadow-green-500 border-2">
        ...
        <div className="text-center mb-8">
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-extrabold mb-6 bg-gradient-to-r from-blue-600 via-purple-600 to-pink-600 bg-clip-text text-transparent animate-pulse text-center">
            About Me
          </h2>
          <div className="w-16 sm:w-20 md:w-24 h-1 bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500 mx-auto rounded-full mb-6 shadow-lg"></div>
