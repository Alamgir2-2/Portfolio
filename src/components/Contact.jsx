      ...
      <div className="container mx-auto px-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="p-8 transform  transition duration-300 rounded-lg shadow-lg shadow-green-500 border">
            <h2 className="text-2xl font-bold text-gray-400 mb-6">Contact Information</h2>
            <div className="space-y-4">
              <div className="flex items-center">
                ...
                <p className="text-gray-700">+880 1319 602545</p>
              </div>
              <div className="flex items-center">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-blue-500 mr-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                </svg>
                <p className="text-gray-700">mahalamgir1213@gmail.com</p>
              </div>
              <div className="flex items-center">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-blue-500 mr-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <p className="text-gray-700">Kulbaria, Samonta, Maheshpur, Jhenaidah, Bangladesh</p>
              </div>
          ...
          <div className=" p-8 rounded-lg transform  transition duration-300 border shadow-lg shadow-green-500">
            ...
            {isSubmitted ? (
              ...
              <form className="space-y-6" onSubmit={handleSubmit}>
                ...
                <div>
                  <button
                    type="submit"
                    className="w-full bg-blue-500 text-white px-4 py-2 rounded-lg hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition duration-300"
                  >
                    Send Message
                  </button>
                </div>
            ...
            <div className="mt-6">
              <h3 className="text-xl font-bold text-gray-400 mb-4">Connect Via</h3>
